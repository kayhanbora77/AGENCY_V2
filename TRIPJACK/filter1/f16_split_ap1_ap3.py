...
SOURCE_TABLE = "TRIPJACK_SPLIT5"
TARGET_TABLE = "TRIPJACK_SPLIT6"
...
def find_all_split_points(flights, airports):
    ...
    Rule 1 — Exactly 2 flights, 3 airports, Airport1 == Airport3:
        ...
        Split at flight boundary 1:
          Segment 1: Flight1 | Airport1 → Airport2       (BOM → IXR)
          Segment 2: Flight2 | Airport2 → Airport3       (IXR → BOM)
