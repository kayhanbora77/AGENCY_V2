...
SOURCE_TABLE = "TRIPJACK_SPLIT10"
TARGET_TABLE = "TRIPJACK_SPLIT11"
...
WHERE AirportIATACode1 = AirportIATACode3
...
def find_all_split_points(flights, airports):
    """
    Rule 1 — Exactly 3 flights, 4 airports, Airport1 == Airport3:
        e.g. SFO → DFW → SFO→ MCI
             [0]    [1]   [2] 
        Split at flight boundary 1:
          Segment 1: Flight1 | Airport1 → Airport2       (SFO → DFW)
          Segment 2: Flight2,Flight3 | Airport2 → Airport3 → Airport4       (DFW → SFO → MCI)
