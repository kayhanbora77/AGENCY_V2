...
SOURCE_TABLE = "THOMASCOOK_SPLIT2"
TARGET_TABLE = "THOMASCOOK_SPLIT3"
...
# SQL condition to identify 3-flight round-trips (AUH -> MCT -> AUH -> XNB)
WHERE_3_FLIGHTS = """
    ...
    AND (FLIGHTNO3 IS NOT NULL OR FLIGHTNO3 <> '')
    AND (DEPARTURE_DATE3 IS NOT NULL)
