...
SOURCE_TABLE = "TBO_SPLIT2"
TARGET_TABLE = "TBO_SPLIT3"
...
def find_all_split_points(flights, airports):
    ...
    Rule 1 — Exactly 3 flights, 4 airports, Airport1 == Airport3:
        ...
        Split at flight boundary 1:
          Segment 1: Flight1          | Airport1 → Airport2          (AUH → MCT)
          Segment 2: Flight2, Flight3 | Airport2 → Airport3 → Airport4 (MCT → AUH → XNB)
