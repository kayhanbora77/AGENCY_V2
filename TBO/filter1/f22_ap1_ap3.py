...
SOURCE_TABLE = "TBO_SPLIT11"
TARGET_TABLE = "TBO_SPLIT12"
...
def find_all_split_points(flights, airports):
    ...
    Rule 1 — Exactly 3 flights, 4 airports, Airport1 == Airport3:
        ...
        Split at flight boundary 1:
          Segment 1: Flight1 | Airport1 → Airport2       (HND → DEL)
          Segment 2: Flight2,Flight3 | Airport2 → Airport3 → Airport4       (DEL → HND→FUK)
