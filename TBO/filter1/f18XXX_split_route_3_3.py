...
SOURCE_TABLE = "TBO_SPLIT6"
TARGET_TABLE = "TBO_SPLIT7"
...
def find_all_split_points(flights, airports):
    ...
    Rule 1 — Exactly 3 flights, 4 airports, Airport2 == Airport4:
        ...
        Split at flight boundary 1:
          Segment 1: Flight1,Flight2 | Airport1 → Airport2 → Airport3           (NAP → FCO → PMO)
          Segment 2: Flight3 | Airport3 → Airport4            (PMO → FCO)
