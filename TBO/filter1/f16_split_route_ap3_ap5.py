...
# Update-1
# UPDATE TBO_SPLIT5
# SET FLIGHTNUMBER3=NULL,DEPARTUREDATELOCAL3=NULL
# WHERE AIRPORT1=AIRPORT3 AND AIRPORT4 IS NULL
#
# Update-2
# UPDATE TBO_SPLIT5
# SET FLIGHTNUMBER2=NULL,DEPARTUREDATELOCAL2=NULL,AIRPORT3=NULL
# WHERE AIRPORT1=AIRPORT3 AND AIRPORT4 IS NULL
# AND FLIGHTNUMBER1=FLIGHTNUMBER2
#
# ============================================================================
# CONFIG
# ============================================================================
...
def find_all_split_points(flights, airports):
    ...
    Rule 1 — Exactly 2 flights, 3 airports, Airport1 == Airport3:
        ...
        Split at flight boundary 1:
          Segment 1: Flight1 | Airport1 → Airport2          (DEL → HKG)
          Segment 2: Flight2 | Airport2 → Airport3          (HKG → DEL)
...
def process_table(db_path=DB_PATH, table=SOURCE_TABLE, batch_size=BATCH_SIZE):
    ...
    # ── Step 2: Fetch and process matching 2-flight round-trip rows ───────────
    ...
    """).fetchone()[0]
    print(
        f"\n  Step 2: Processing {filtered_total:,} 2-flight round-trip rows for split..."
    )
