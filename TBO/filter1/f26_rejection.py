...
SOURCE_TABLE = "TBO_CLEANED5"  # input  table (read-only)
TARGET_TABLE = "TBO_CLEANED6"  # output table for clean / passing rows
REJECTION_TABLE = "TBO_REJECTION3"  # output table for rejected rows
