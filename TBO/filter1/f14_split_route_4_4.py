...
def find_all_split_points(flights, airports):
    """
    Rule 1 — Exactly 4 flights, 5 airports, Airport1 == Airport5:
        e.g. BOM → DXB → BOS → DXB → BOM
             [0]    [1]   [2]   [3]   [4]
        Split at flight boundary 1:
          Segment 1: Flight1,Flight2 | Airport1 → Airport2 → Airport3           (BOM → DXB → BOS)
          Segment 2: Flight3,Flight4 | Airport3 → Airport4 → Airport5  (BOS → DXB → BOM)
