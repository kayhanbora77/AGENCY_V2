...
WHERE ((AIRPORT2 = AIRPORT4) AND (AIRPORT1<>AIRPORT5) AND (AIRPORT6 IS NULL))
"""
...
def find_all_split_points(flights, airports):
    """
    Rule 1 — Exactly 4 flights, Airport2 == Airport4, Airport1<>Airport5, Airport6 IS NULL:
    ...
    # ── Rule 1: exactly 4 flights and Airport2 == Airport4 and Airport1<>Airport5 and Airport6 IS NULL ───────────────────
    if n_f == 4 and n_a == 5 and airports[1] == airports[3] and airports[0] != airports[4]:
        split_points.add(2)
