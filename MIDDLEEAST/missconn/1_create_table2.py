...
# CONFIG
# =====================================================
CSV_FILE = r"C:\Users\cagri\Desktop\MiddleEast\MiddleEast_MissConn2.csv"
DB_PATH = r"C:\DuckDB\my_db.duckdb"
TABLE_NAME = "MIDDLEEAST_MISSCONNECTION2"
...
SELECT
    ...
    CAST(src.IsMultiSegment AS VARCHAR)             AS IsMultiSegment
